...
import { Loader2, Trash2, Shield, Code, ChevronRight, Info } from "lucide-react";
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-2">
        {installedScripts.map((script) => (
          <div
            key={script.id}
            className="group flex items-center justify-between p-3 rounded-xl border border-white/5 bg-white/2 hover:bg-white/5 transition-all duration-300"
          >
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <div className="flex flex-col gap-0.5 overflow-hidden">
                <div className="flex items-center gap-1.5 overflow-hidden">
                  ...
                  <Badge className="text-[9px] h-3.5 px-1 bg-white/10 font-normal">
                    v{script.version}
                  </Badge>
                </div>
                <div className="flex items-center gap-2 text-[10px] text-muted-foreground">
                  ...
                  <TooltipProvider delayDuration={0}>
                    <Tooltip>
                      ...
                      <TooltipContent side="bottom" className="text-[10px] bg-popover border border-border">
                        ID: {script.id}
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
